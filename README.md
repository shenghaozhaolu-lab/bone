...
<div class="container">
    ...
    <div class="upload-area">
        ...
        <p class="tip-text">
            지원 형식: JPG / PNG / JPEG | 支持格式：JPG / PNG / JPEG
        </p>
    </div>
    ...
    <div class="grid">
        ...
        <div class="card result">
            ...
            <div class="score">
                신뢰도(置信度)：<span id="confidence">0%</span>
            </div>
...
// 核心：分析图片（模拟AI检测，随机生成 正常/骨折 两种结果）
function analyzeImage() {
    ...
    setTimeout(() => {
        // 随机模拟两种结果：骨折 / 正常
        const isFracture = Math.random() > 0.4; // 60%概率检测出骨折
        const randomScore = (Math.random() * 15 + 85).toFixed(1); // 置信度 85 ~ 100
...
function resetAll() {
    fileInput.value = '';
    preview.src = 'fracture.jpg'; // 恢复默认图
    hasFile = false;
    resetResult();
    analyzeBtn.disabled = false;
}
